import numpy as np
from scipy.optimize import fmin_l_bfgs_b, NonlinearConstraint, minimize
...
class BO_algo():
    def __init__(self):
        ...
        self.gpv = gp.GaussianProcessRegressor(kernel = np.sqrt(2) * gp.kernels.Matern(length_scale=1,nu=2.5, length_scale_bounds="fixed"))
        self.x = []
        self.f = []
        self.v = []
    ...
    def optimize_acquisition_function(self):
        ...
        for _ in range(20):
            ...
            result = fmin_l_bfgs_b(objective, x0=x0, bounds=DOMAIN,
                                   approx_grad=True)
            #result = minimize(objective, x0, method="L-BFGS-B", constraints=const)
            #print(result)
